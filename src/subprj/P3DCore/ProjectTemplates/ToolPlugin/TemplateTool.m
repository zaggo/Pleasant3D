...
//  Pleasant3D and the P3DCore.framework are Copyright 2009-«YEAR» Pleasant Software.
//  All rights reserved.
//
...
+ (void)initialize
{
	...
	NSDictionary *ddef = [NSDictionary dictionaryWithObjectsAndKeys:
						  ...
						  nil];
	[«PROJECTNAMEASIDENTIFIER» registerDefaultPreset:ddef];
}
...
{
	return NSLocalizedStringFromTableInBundle(@"Sample Tool", nil, [NSBundle bundleForClass:[self class]], @"Localized Display Name for Tool");
}
...
{
	return @"«PROJECTNAMEASIDENTIFIER»SettingsGUI";
}
